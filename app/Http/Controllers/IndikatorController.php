...
class IndikatorController extends Controller
{
    ...
    {
        $messages = [
            'nama.required'         => 'Nama Indikator Kinerja tidak boleh kosong',
            'nama.unique'         => 'Nama Indikator Kinerja terdeteksi existing',
		];
		$validator = Validator::make(request()->all(), [
			'nama'          => 'required|unique:indikator,nama,'.$id.',id',
		],
		$messages
        )->validate();
        ...
        $data->save();
        return response()->json(['message' => 'Indikator Kinerja berhasil diperbaharui']);
    }
