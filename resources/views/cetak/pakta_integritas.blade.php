...
<div class="container-fluid">
    ...
    <p>Dengan ini Saya sebagai Kepala Sekolah {{$sekolah->nama}} menyatakan bahwa data yang diisi pada kuesioner Penjaminan Mutu SMK tahun pendataan {{$tahun_pendataan->tahun_pendataan_id}} telah diperiksa kebenarannya dan telah sesuai dengan fakta yang ada di lapangan.</p>
