                        ...
                        <div class="card">
                            <div class="card-header card-warna-{{strtolower($komponen[0]->nama)}}">
                                ...
                                <div class="card-tools">
                                    <span class="avg">{{number_format($komponen[0]->all_nilai_komponen_verifikasi->avg('total_nilai'),2)}}</span>
                                    <span class="bintang">{!! Helper::bintang_icon(number_format($komponen[0]->all_nilai_komponen_verifikasi->avg('total_nilai'),2), 'warning') !!}</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-header card-warna-{{strtolower($komponen[1]->nama)}}">
                                ...
                                <div class="card-tools">
                                    <span class="avg">{{number_format($komponen[1]->all_nilai_komponen_verifikasi->avg('total_nilai'),2)}}</span>
                                    <span class="bintang">{!! Helper::bintang_icon(number_format($komponen[1]->all_nilai_komponen_verifikasi->avg('total_nilai'),2), 'warning') !!}</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header card-warna-{{strtolower($komponen[2]->nama)}}">
                                ...
                                <div class="card-tools">
                                    <span class="avg">{{number_format($komponen[2]->all_nilai_komponen_verifikasi->avg('total_nilai'),2)}}</span>
                                    <span class="bintang">{!! Helper::bintang_icon(number_format($komponen[2]->all_nilai_komponen_verifikasi->avg('total_nilai'),2), 'warning') !!}</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-header card-warna-{{strtolower($komponen[3]->nama)}}">
                                ...
                                <div class="card-tools">
                                    <span class="avg">{{number_format($komponen[3]->all_nilai_komponen_verifikasi->avg('total_nilai'),2)}}</span>
                                    <span class="bintang">{!! Helper::bintang_icon(number_format($komponen[3]->all_nilai_komponen_verifikasi->avg('total_nilai'),2), 'warning') !!}</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header card-warna-{{strtolower($komponen[4]->nama)}}">
                                ...
                                <div class="card-tools">
                                    <span class="avg">{{number_format($komponen[4]->all_nilai_komponen_verifikasi->avg('total_nilai'),2)}}</span>
                                    <span class="bintang">{!! Helper::bintang_icon(number_format($komponen[4]->all_nilai_komponen_verifikasi->avg('total_nilai'),2), 'warning') !!}</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row">
                            ...
                            <div class="card-header bg-secondary">
                                ...
                                <div class="card-tools">
                                    ...
                                    foreach($komponen_kinerja as $kinerja){
                                        $rerata_kinerja[] = number_format($kinerja->all_nilai_komponen_verifikasi->avg('total_nilai'),2);
                                    }
                                    ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="position-relative p-3 mb-3 card-warna-{{strtolower($kinerja->nama)}} text-center" style="height:125px">
                                            {{$kinerja->nama}} <br>
                                            <h1 class="kinerja-{{strtolower(Helper::clean($kinerja->nama))}}">{{number_format($kinerja->all_nilai_komponen_verifikasi->avg('total_nilai'),2)}}</h1>
                                            <span class="bintang-kinerja">{!! Helper::bintang_icon(number_format($kinerja->all_nilai_komponen_verifikasi->avg('total_nilai'),2), 'warning') !!}</span>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="card-header bg-secondary">
                                ...
                                <div class="card-tools">
                                    ...
                                    foreach($komponen_dampak as $dampak){
                                        $rerata_dampak[] = number_format($dampak->all_nilai_komponen_verifikasi->avg('total_nilai'),2);
                                    }
                                    ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="position-relative p-3 mb-3 card-warna-{{strtolower($dampak->nama)}} text-center" style="height:125px">
                                            {{$dampak->nama}} <br>
                                            <h1 class="dampak-{{strtolower(Helper::clean($dampak->nama))}}">{{number_format($dampak->all_nilai_komponen_verifikasi->avg('total_nilai'),2)}}</h1>
                                            <span class="bintang-dampak">{!! Helper::bintang_icon(number_format($dampak->all_nilai_komponen_verifikasi->avg('total_nilai'),2), 'warning') !!}</span>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
...
$('#provinsi_id').change(function(){
	...
	var ini = $(this).val();
	if(ini == ''){
        $.get( "{{route('get_chart_verifikasi')}}", function( data ) {
            tampilChart(data)
        });
		return false;
	}
	$.ajax({
		...
		success: function(response){
            ...
            $.each(response.output.all_kinerja.nama, function (i, item) {
                ...
                $('h1.kinerja-'+item).html(response.output.all_kinerja.nilai_verifikasi[i]);
            })
            $.each(response.output.all_dampak.nama, function (i, item) {
                var a = $('h1').hasClass('dampak-'+item);
                $('h1.dampak-'+item).html(response.output.all_dampak.nilai_verifikasi[i]);
            })
            ...
            $.each($('.avg'), function(i, val) {
                $(this).html(response.nilai_komponen_kotak[i].nilai_verifikasi)
            })
