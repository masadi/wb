    ...
    <div>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Data Laporan Verifikasi</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><router-link tag="a" to="/beranda">Beranda</router-link></li>
                            <li class="breadcrumb-item active">Data Laporan Verifikasi</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
<script>
    import Datatable from './../components/Laporan_verifikasi.vue' //IMPORT COMPONENT DATATABLENYA
...
export default {
    ...
    methods: {
        loadPostsData() {
            ...
            axios.get(`/api/laporan/list-verifikasi`, {
