    ...
    <div>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Data Laporan Pendampingan</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><router-link tag="a" to="/beranda">Beranda</router-link></li>
                            <li class="breadcrumb-item active">Data Laporan Pendampingan</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
...
<script>
    import Datatable from './../components/Laporan_pendampingan.vue' //IMPORT COMPONENT DATATABLENYA
...
export default {
    ...
    data() {
        return {
            ...
            fields: [
                ...
                {key: 'pendamping_id', 'label': 'Nama Pendamping', sortable: true},
    ...
    methods: {
        loadPostsData() {
            ...
            axios.get(`/api/laporan/list-pendampingan`, {
