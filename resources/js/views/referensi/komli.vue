...
<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Data Kompetensi Keahlian</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <app-datatable :items="items" :fields="fields" :meta="meta" :title="'Hapus Kompetensi Keahlian'" @per_page="handlePerPage" @pagination="handlePagination" @search="handleSearch" @sort="handleSort" />
                        </div>
                    </div>
                </div>
            </div>
...
<script>
import Datatable from './../components/Komli.vue' //IMPORT COMPONENT DATATABLENYA
...
export default {
    ...
    methods: {
        ...
        insertData() {
            this.form.post('/api/sinkronisasi/komli').then((response) => {
