    ...
    <div>
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Data Indikator</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
...
<script>
    ...
    import Datatable from './../components/Indikator.vue' //IMPORT COMPONENT DATATABLENYA
...
export default {
    ...
    data() {
        return {
            ...
            fields: [
                {key: 'id', 'label': 'ID Indikator', sortable: true},
                {key: 'nama', 'label': 'Nama Indikator', sortable: true},
    ...
    methods: {
        loadPostsData() {
            ...
            axios.get(`/api/referensi/indikator`, {
