...
<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Data Peserta Didik</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
<script>
import Datatable from './../components/Pd.vue' //IMPORT COMPONENT DATATABLENYA
...
export default {
    ...
    methods: {
        ...
        insertData() {
            this.form.post('/api/sinkronisasi/pd').then((response) => {
