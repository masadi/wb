...
<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Data Pendidikan & Tenaga Kependidikan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Data Pendidikan & Tenaga Kependidikan</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<script>
import Datatable from './../components/Ptk.vue' //IMPORT COMPONENT DATATABLENYA
...
export default {
    ...
    methods: {
        ...
        insertData() {
            this.form.post('/api/sinkronisasi/ptk').then((response) => {
