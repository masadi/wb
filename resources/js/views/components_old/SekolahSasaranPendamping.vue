...
<div>
    ...
    <b-table striped hover :items="items" :fields="fields" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" show-empty>
        <template v-slot:cell(actions)="row">
            <b-button variant="danger" size="sm" v-show="permintaan == 'list'" v-on:click="hapusData(pendamping_id, row.item.sekolah_id)">Hapus</b-button>
            <b-button variant="primary" size="sm" v-show="permintaan == 'add'" v-on:click="simpanData(pendamping_id, row.item.sekolah_id)">Tambahkan</b-button>
        </template>
    </b-table>
